...
| 🛠️ **Sonstige / maximale Version** | Offizieller Installer: [go.dev/dl/](https://go.dev/dl/) |
...
| Editor markiert Code rot, aber `go run .` läuft | VS Code → `Cmd/Ctrl + Shift + P` → *Go: Restart Language Server*. |

---

## 🗺️ Weiter nach dem Setup
