...
- **Grün: Ich habe noch nie programmiert.** Starte bei [`00_erste_schritte/`](00_erste_schritte) (reine Theorie, ca. 10 min), gehe dann [`00_geschichte/`](00_geschichte) und danach [`00_intro/`](00_intro) in Ruhe durch.
- **Gelb: Ich habe schon mal was programmiert (Schule, Hobby).** Überspringe die Theorie-Kapitel, starte bei [`00_intro/`](00_intro).
- **Orange: Ich beherrsche eine andere Sprache und will Go lernen.** Lies die [Hinweise](#wichtige-hinweise-zu-go-vs-anderen-sprachen) und starte bei [`01_basics/`](01_basics).
...
### Teil 3: Praxis und Concurrency

- [`09_concurrency/`](09_concurrency) **Nebenläufigkeit:** Goroutinen, Channels, Select
- [`10_file_io/`](10_file_io) **Dateien und Daten:** Dateien lesen/schreiben, JSON, CSV
...
## Wichtige Hinweise zu Go vs. anderen Sprachen
...
3. In der [Setup-Anleitung](SETUP.md) den Go Playground öffnen (kein Download!)
4. [`00_intro/main.go`](00_intro/main.go) lesen und den Code in den Playground kopieren
5. Klicke **Run**: du hast gerade dein erstes Programm ausgeführt!
6. Ändere einen Text im Code und klicke erneut **Run**: du experimentierst
7. Weiter zu [`01_basics/`](01_basics) und so Stück für Stück vorwärts
8. Fremde Begriffe? Schau im [Glossar](GLOSSARY.md) oder in der [FAQ](FAQ.md) nach
9. Am Ende jedes Kapitels: Übungen machen (und nicht direkt in die Lösungen schauen!)
