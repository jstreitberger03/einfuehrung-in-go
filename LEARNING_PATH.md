...
> Grün = Pflicht (überspringe nichts) · Gelb = empfohlen · Orange = optional / Bonus
...
> Lies zuerst **[SETUP.md](SETUP.md)**. Wenn du keine Installation willst: nur den Go Playground nutzen, kein Download nötig.
...
| # | Kapitel | Dauer | Pflicht? |
|---|---------|-------|----------|
| 2 | [`00_intro/`](00_intro) | 30 min | Pflicht |
| 3 | [`01_basics/`](01_basics) | 60 min | Pflicht |
| 4 | [`02_control_flow/`](02_control_flow) | 60 min | Pflicht |
...
> **Tipp:** Mach die Übungen am Ende jedes Kapitels. Wirklich. Sie sind klein, aber bringen viel.
...
| # | Kapitel | Dauer | Pflicht? |
|---|---------|-------|----------|
| 5 | [`03_functions/`](03_functions) | 60 min | Pflicht |
| 6 | [`04_data_structures/`](04_data_structures) | 60 min | Pflicht |
| 7 | [`05_structs_interfaces/`](05_structs_interfaces) | 90 min | Pflicht |
...
> **Pause empfohlen** nach diesem Block. Lass die Konzepte sacken.
...
| # | Kapitel | Dauer | Pflicht? |
|---|---------|-------|----------|
| 8 | [`06_pointers/`](06_pointers) | 45 min | Pflicht |
| 9 | [`07_error_handling/`](07_error_handling) | 60 min | Pflicht |
| 10 | [`08_packages_modules/`](08_packages_modules) | 45 min | Pflicht |
...
| # | Kapitel | Dauer | Pflicht? |
|---|---------|-------|----------|
| 11 | [`09_concurrency/`](09_concurrency) | 90 min | Pflicht |
| 12 | [`10_file_io/`](10_file_io) | 60 min | Pflicht |
| 13 | [`11_testing/`](11_testing) | 45 min | Pflicht |
...
| # | Kapitel | Dauer | Pflicht? |
|---|---------|-------|----------|
| 14 | [`12_projects/`](12_projects) | mehrere Stunden | Pflicht |
...
| System-Tools und CLI | [Cobra](https://github.com/spf13/cobra) |
